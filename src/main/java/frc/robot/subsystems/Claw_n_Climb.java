...
public class Claw_n_Climb extends TimedRobot {
  /*
  ...
   */
  CANSparkBase kFrontLeftDrivingCanId = new CANSparkMax(1, MotorType.kBrushless);
  CANSparkBase kRearLeftDrivingCanId = new CANSparkMax(2, MotorType.kBrushless);
  CANSparkBase kFrontRightDrivingCanId = new CANSparkMax(3, MotorType.kBrushless);
  CANSparkBase kRearRightDrivingCanId = new CANSparkMax(4, MotorType.kBrushless);

  CANSparkBase kFrontLeftTurningCanId = new CANSparkMax(5, MotorType.kBrushless);
  CANSparkBase kRearLeftTurningCanId = new CANSparkMax(6, MotorType.kBrushless);
  CANSparkBase kFrontRightTurningCanId = new CANSparkMax(7, MotorType.kBrushless);
  CANSparkBase kRearRightTurningCanId = new CANSparkMax(8, MotorType.kBrushless);
 ...
 /**
  ...
  public void robotInit() {
    ...
     */
    kFrontLeftDrivingCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);
    kRearLeftDrivingCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);
    kFrontRightDrivingCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);
    kRearRightDrivingCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);

    kFrontLeftTurningCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);
    kRearLeftTurningCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);
    kFrontRightTurningCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);
    kRearRightTurningCanId.setSmartCurrentLimit(DRIVE_CURRENT_LIMIT_A);

    /*
     * Tells the rear wheels to follow the same commands as the front wheels
     */
    kRearLeftDrivingCanId.follow(kFrontLeftDrivingCanId);
    kRearRightDrivingCanId.follow(kFrontRightDrivingCanId);

    /*
     * One side of the drivetrain must be inverted, as the motors are facing opposite directions
     */
    kFrontLeftDrivingCanId.setInverted(true);
    kFrontRightDrivingCanId.setInverted(false);

    m_drivetrain = new DifferentialDrive(kFrontLeftDrivingCanId, kFrontRightDrivingCanId);
  ...
  public void autonomousInit() {
    ...
    kFrontLeftDrivingCanId.setIdleMode(IdleMode.kBrake);
    kRearLeftDrivingCanId.setIdleMode(IdleMode.kBrake);
    kFrontRightDrivingCanId.setIdleMode(IdleMode.kBrake);
    kRearRightDrivingCanId.setIdleMode(IdleMode.kBrake);
    
    kFrontLeftTurningCanId.setIdleMode(IdleMode.kBrake);
    kRearLeftTurningCanId.setIdleMode(IdleMode.kBrake);
    kFrontRightTurningCanId.setIdleMode(IdleMode.kBrake);
    kRearRightTurningCanId.setIdleMode(IdleMode.kBrake);
  ...
  public void teleopInit() {
    ...
     */
    kFrontLeftDrivingCanId.setIdleMode(IdleMode.kCoast);
    kRearLeftDrivingCanId.setIdleMode(IdleMode.kCoast);
    kFrontRightDrivingCanId.setIdleMode(IdleMode.kCoast);
    kRearRightDrivingCanId.setIdleMode(IdleMode.kCoast);

    kFrontLeftTurningCanId.setIdleMode(IdleMode.kCoast);
    kRearLeftTurningCanId.setIdleMode(IdleMode.kCoast);
    kFrontRightTurningCanId.setIdleMode(IdleMode.kCoast);
    kRearRightTurningCanId.setIdleMode(IdleMode.kCoast);
  }
