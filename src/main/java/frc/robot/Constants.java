...
public final class Constants {
  public static final class DriveConstants {
    ...
    // Spark Flex CAN IDs for the note shooter to reflect the IDs changed on lines 150-154 - Balke
    public static final int kFeederID = 16;
    public static final int kLauncherID = 15;
  
    // Spark Flex & Max CAN IDs for Claw and Climber Motors.
    public static final int m_rollerClawCanId = 17;
    public static final int m_climberCanId = 18;  
  ...
  public static class kLauncherConstants {
    // PWM ports/CAN IDs for motor controllers
    // CAN IDs changed to reflect the CT ideas for these motors
    public static final int kFeederID = 16;
    public static final int kLauncherID = 15;
    ...
    // in reverse
    // We have a right shooter so the values have been flipped from the original - Balke
